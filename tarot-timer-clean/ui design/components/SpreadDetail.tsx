    ...
    <div className="h-full bg-gradient-to-br from-midnight-blue via-deep-purple to-midnight-blue relative">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div 
          ...
          style={{
            backgroundColor: tokens.colors.midnightBlue + '99', // 60% opacity
          }}
        >
          <Button 
            variant="outline" 
        ...
        {/* React Native 호환 제목 입력 섹션 */}
        <div 
          className="flex-shrink-0 px-4 py-3 border-b border-premium-gold/10"
          style={{
            background: `linear-gradient(to right, ${tokens.colors.midnightBlue}80, ${tokens.colors.midnightBlue}66, ${tokens.colors.midnightBlue}80)`,
          }}
        >
        ...
        <div className="flex-1 relative overflow-hidden">
          {spread.id === 'celtic-cross' ? (
            ...
            <div className="w-full h-full relative bg-gradient-to-br from-deep-purple via-midnight-blue to-deep-purple">
              <CelticCrossLayout 
                positions={currentReading} 
                onCardClick={handleCardClick}
              />
            </div>
          ) : spread.id === 'three-card' ? (
            /* React Native 호환 3카드 레이아웃 */
            <div className="w-full h-full relative bg-gradient-to-br from-deep-purple via-midnight-blue to-deep-purple">
              <ThreeCardLayout 
                positions={currentReading} 
                onCardClick={handleCardClick}
            ...
            /* React Native 호환 AB Choice 레이아웃 */
            <div className="w-full h-full relative bg-gradient-to-br from-deep-purple via-midnight-blue to-deep-purple">
              <ABChoiceLayout 
                positions={currentReading} 
                onCardClick={handleCardClick}
          ...
          ) : spread.id === 'career' || spread.id === 'ab-choice' ? (
            /* AB선택/커리어 스프레드 - React Native 호환 레이아웃 */
